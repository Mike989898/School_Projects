...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ACCUM_REG_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.ACCUM_REG_WIDTH { PARAM_VALUE.ACCUM_REG_WIDTH } {
	# Procedure called to update ACCUM_REG_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ACCUM_REG_WIDTH { PARAM_VALUE.ACCUM_REG_WIDTH } {
	# Procedure called to validate ACCUM_REG_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.ACCUM_REG_WIDTH { MODELPARAM_VALUE.ACCUM_REG_WIDTH PARAM_VALUE.ACCUM_REG_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ACCUM_REG_WIDTH}] ${MODELPARAM_VALUE.ACCUM_REG_WIDTH}
}
