...
## jpeyron, https://github.com/Digilent/ZYBO/blob/master/Resources/XDC/ZYBO_Master.xdc

## E.W. Hansen, Nov 7, 2016:  Digilent PMOD nomenclature on schematic does not agree with
## nomenclature in reference manual.  See below for correlations.
## This XDC file does not include the JF PMOD port, which is connected to the MIO bus in
## in the Zynq PS and accessed via PS peripheral controller cores (GPIO, UART, I2C, SPI).


##Clock signal
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { Clk125 }]; #IO_L11P_T1_SRCC_35 Sch=sysclk
...
##Pmod Header JA (XADC)
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { ja_p[0] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p, RM=JA1
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { ja_p[1] }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P, RM=JA2
#set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { ja_p[2] }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P, RM=JA3
#set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { ja_p[3] }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P, RM=JA4
#set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { ja_n[0] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N, RM=JA7
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { ja_n[1] }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N, RM=JA8
#set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { ja_n[2] }]; #IO_L24N_T3_AD15N_35 Sch=JA3_R_N, RM=JA9
#set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { ja_n[3] }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N, RM=JA10


##Pmod Header JB
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[0] }]; #IO_L15P_T2_DQS_34 Sch=JB1_p, RM=JB1
set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[1] }]; #IO_L15N_T2_DQS_34 Sch=JB1_N, RM=JB2
set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[2] }]; #IO_L16P_T2_34 Sch=JB2_P, RM=JB3
set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[3] }]; #IO_L16N_T2_34 Sch=JB2_N, RM=JB4
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[4] }]; #IO_L17P_T2_34 Sch=JB3_P, RM=JB7
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[5] }]; #IO_L17N_T2_34 Sch=JB3_N, RM=JB8
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[6] }]; #IO_L22P_T3_34 Sch=JB4_P, RM=JB9
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { clp_data_tri_io[7] }]; #IO_L22N_T3_34 Sch=JB4_N, RM=JB10


##Pmod Header JC
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { jc_p[0] }]; #IO_L10P_T1_34 Sch=JC1_P, RM=JC1
#set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { jc_n[0] }]; #IO_L10N_T1_34 Sch=JC1_N, RM=JC2
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { jc_p[1] }]; #IO_L1P_T0_34 Sch=JC2_P, RM=JC3
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { jc_n[1] }]; #IO_L1N_T0_34 Sch=JC2_N, RM=JC4
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { clp_control_tri_o[0] }]; #IO_L8P_T1_34 Sch=JC3_P, RM=JC7
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { clp_control_tri_o[1] }]; #IO_L8N_T1_34 Sch=JC3_N, RM=JC8
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { clp_control_tri_o[2] }]; #IO_L2P_T0_34 Sch=JC4_P, RM=JC9
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { clp_control_tri_o[3] }]; #IO_L2N_T0_34 Sch=JC4_N, RM=JC10


##Pmod Header JD
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { da2_spi_syncL }]; #IO_L5P_T0_34 Sch=JD1_P, RM=JD1
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { da2_spi_mosi1 }]; #IO_L5N_T0_34 Sch=JD1_N, RM=JD2
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { da2_spi_mosi2 }]; #IO_L6P_T0_34 Sch=JD2_P, RM=JD3
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { da2_spi_sclk }]; #IO_L6N_T0_VREF_34 Sch=JD2_N, RM=JD4
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { jd_p[2] }]; #IO_L11P_T1_SRCC_34 Sch=JD3_P, RM=JD7
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { jd_n[2] }]; #IO_L11N_T1_SRCC_34 Sch=JD3_N, RM=JD8
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { jd_p[3] }]; #IO_L21P_T3_DQS_34 Sch=JD4_P, RM=JD9
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { jd_n[3] }]; #IO_L21N_T3_DQS_34 Sch=JD4_N, RM=JD10


##Pmod Header JE
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { ad1_spi_syncL }]; #IO_L4P_T0_34 Sch=JE1, RM=JE1
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { ad1_spi_miso1 }]; #IO_L18N_T2_34 Sch=JE2, RM=JE2
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { ad1_spi_miso2 }]; #IO_25_35 Sch=JE3, RM=JE3
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { ad1_spi_sclk }]; #IO_L19P_T3_35 Sch=JE4, RM=JE4
#set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { je[4] }]; #IO_L3N_T0_DQS_34 Sch=JE7, RM=JE7
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { je[5] }]; #IO_L9N_T1_DQS_34 Sch=JE8, RM=JE8
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { je[6] }]; #IO_L20P_T3_34 Sch=JE9, RM=JE9
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { je[7] }]; #IO_L7N_T1_34 Sch=JE10, RM=JE10
